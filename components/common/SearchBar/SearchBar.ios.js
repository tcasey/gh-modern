...
const SearchIcon = ({ color }) => (
  <View style={styles.searchIconContainer}>
    <Icon.AntDesign name="search1" size={16} color={color || '#ccc'} />
  </View>
)
  ...
  render() {
    ...
    const dynamicStyles = StyleSheet.create({
      searchContainer: {
        ...
        backgroundColor: this.props.inputBackgroundColor || '#f2f2f2',
        borderRadius: 5,
    ...
    return (
      <View style={styles.container}>
        <View style={[dynamicStyles.searchContainer, { width: inputWidth }]}>
          <TextInput
            ref={view => {
          ...
          <SearchIcon color={this.props.inputIconColor} />
        </View>
